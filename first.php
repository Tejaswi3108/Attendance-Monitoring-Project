...
<body style="background-color: beige;">
      <div class="header">
			...
			<ul class="nav">
				...
				<li><a href="" style="color:#1c8adb;;font-weight:bold;">First Year</a></li>
...
<input type="submit" name="deleteF" value="Delete All" style="position: absolute; top:20px; left: 1100px; border: none;outline: none;height: 40px;width: 150px;background: #143D59;color: #fff;font-size: 18px;border-radius: 20px;"></li>
</form>
	  ...
	  if (isset($_POST['submit']))
{
	...
	if($rollno!=""|| $enroll!=""|| $fname!="")
	{
	    ...
	    $sql ="insert into FirstYear(roll,enroll,fname)
	     values ('$rollno','$enroll','$fname')";
		$result=mysqli_query($db, $sql);
		$s1="Insert into firstdemo (roll) values ('$rollno')";
		$r1=mysqli_query($db,$s1);
		$avgF=mysqli_query($db,"Insert into averageF (roll) values ('$rollno')");
	}
}
?>
</form>
