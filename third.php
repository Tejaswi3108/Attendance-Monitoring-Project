...
<body>
		...
		<div class="header">
			<ul class="nav">
				...
				<li><a href="#"  style="color:#1c8adb;;font-weight:bold;">Third Year</a></li>
				<li><a href="logout.php">Logout</a></li>
			</ul>
		</div>
<form action="delete.php" method="post">
<input type="submit" name="deleteT" value="Delete All" style="position: absolute; top:20px; left: 1100px; border: none;outline: none;height: 40px;width: 150px;background: #143D59;color: #fff;font-size: 18px;border-radius: 20px;"></li>
</form>
	  ...
	  if (isset($_POST['submit']))
{
	...
	if($rollno!=""|| $enroll!=""|| $fname!="")
	{
	    ...
	    $sql ="insert into thirdyear(roll,enroll,fname) values ('$rollno','$enroll','$fname')";
		$result=mysqli_query($db, $sql);
		$s3="Insert into demothird (roll) values('$rollno')";
		$r3=mysqli_query($db,$s3);
		$avgT=mysqli_query($db,"Insert into averageT (roll)values('$rollno')");
